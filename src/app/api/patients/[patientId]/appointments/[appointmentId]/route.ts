		...
		const result: AppointmentDetail = {
			...
			doctor: {
				...
				user: {
					...
					city: appointment.doctor.user.location.city,
					state: appointment.doctor.user.location.state,
					pinCode: appointment.doctor.user.location.pinCode,
			...
			patient: {
				...
				user: {
					...
					city: appointment.patient.user.location.city,
					state: appointment.patient.user.location.state,
					pinCode: appointment.patient.user.location.pinCode,
